...
export const constructionConfig = {
  ...
  timelineDistributions: {
    ...
    "6-months": [21.9, 18.4, 18.0, 17.8, 17.8, 6.1],
    "9-months": [20.0, 18.0, 16.0, 15.0, 14.0, 8.0, 5.0, 2.0, 2.0],
    "12-months": [15.0, 12.0, 11.0, 11.0, 10.0, 9.0, 8.0, 8.0, 7.0, 5.0, 2.0, 2.0]
  },
  disclaimer: "All calculations are planning estimates based on thumb rules. Final pricing depends on site conditions, structural design, market rates, selected brands, and execution scope."
};
...
export function calculateLineItemTotal(rate: number, quantity: number): number {
